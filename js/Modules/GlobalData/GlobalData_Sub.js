...
var ImagesInc_PageSections = (function (mainModule, subModule) {
  ...
  pageSections.headerContainerDefObj = {
    sectionHTML: `
      <div id="logoDiv" class="logo_titleClass">
...
// and tight augmentation to augment ImadesInc_PageSections

(function (mainModule, subModule) {
  // object definition for the index.html content area
  subModule.mainContentContainerDefObj = {
    imagesArray: ['Image_1.jpg', 'Image_2.jpg', 'Image_3.jpg', 'Image_4.jpg', 'Image_5.jpg', 'Image_6.jpg', 'Image_7.jpg', 'Image_8.jpg', 'Image_9.jpg', ]
  };
