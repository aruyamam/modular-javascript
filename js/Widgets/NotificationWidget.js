ImagesInc_Core.registerComponent('mainPageContainer', 'notificationWidget',
  function (sandBox) {
    var widgetInnerHTMLStr = `
      <div id="notificationMainContainer">
        <h1 className="centerElem header">Thank you for visiting us.</h1>
        <h3 className="centerElem header">All the images on this site are provided by <a href="https://stocksnap.io">stocksnap.io</a></h3>
        <h3 className="centerElem header">We thank them and encourage you to visit theri site.</h3>
        <div className="buttonContainer">
          <div className="button button-left" id="notification_visit">Visit stocksnap.io</div>
          <div className="button button-right" id="notification_close">Close</div>
        </div>
      </div>
    `;

    var widgetMainContainer,
        stockSnapURL = 'https://stocksnap.io';
    ...
    return {
      ...
      renderWidget: function () {
        ...
        generateWidge = sandBox.createDocumentLevelComponent(widgetInnerHTMLStr);
        generateWidget.id = 'widgetContainer';
        sandBox.setElementContext(generateWidget.id);
